...
{
    // Exercise C: Compute the dot product of two vectors using AVX2 intrinsics
    /*
   * Process 8 elements per iteration
   * Load the vectors using simd_loadu_ps
   * Multiply the vectors using simd_mul_ps
   * Sum the elements using simd_reduce_add_ps
    */
